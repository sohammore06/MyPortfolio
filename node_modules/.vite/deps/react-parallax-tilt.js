    ...
    super(...arguments), this.wrapperEl = { node: null, size: { width: 0, height: 0, left: 0, top: 0 }, clientPosition: { x: null, y: null, xPercentage: 0, yPercentage: 0 }, updateAnimationId: null, scale: 1 }, this.tilt = null, this.glare = null, this.addDeviceOrientationEventListener = () => i(this, void 0, void 0, function* () {
      ...
      switch (t2.type) {
        ...
        case "deviceorientation":
          ...
          break;
        case "autoreset": {
          const { tiltAngleXInitial: t3, tiltAngleYInitial: e3, tiltMaxAngleX: i2, tiltMaxAngleY: n2 } = this.props, r2 = e3 / n2 * 100;
          this.wrapperEl.clientPosition.xPercentage = s(t3 / i2 * 100, -100, 100), this.wrapperEl.clientPosition.yPercentage = s(r2, -100, 100), this.wrapperEl.scale = 1;
          break;
        }
      }
